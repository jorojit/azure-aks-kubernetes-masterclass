...
- **Name:** awsbestbractices.com
- **Resource Group Location:** East US
- Click on **Review + Create**

## Step-03: Make a note of Azure Nameservers
- Go to Services -> **DNS Zones** -> **awsbestbractices.com**
...
```
nslookup -type=SOA awsbestbractices.com
nslookup -type=NS awsbestbractices.com
```
- Go to AWS Route53 (This is my Domain Provider)
- Go to Services -> Route53 -> Registered Domains -> awsbestbractices.com
- Click on **Add or edit name servers**
- Update Azure Name servers here and click on **Update**
- Click on **Hosted Zones**
- Delete the hosted zone with name **awsbestbractices.com**
- **Verify after updation**
```
nslookup -type=SOA awsbestbractices.com 8.8.8.8
nslookup -type=NS awsbestbractices.com 8.8.8.8
```
